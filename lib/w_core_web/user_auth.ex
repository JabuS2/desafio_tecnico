defmodule WCoreWeb.UserAuth do
  ...
  the `current_scope`:
      ...
      defmodule WCoreWeb.PageLive do
        use WCoreWeb, :live_view

        on_mount {WCoreWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{WCoreWeb.UserAuth, :require_authenticated}] do
